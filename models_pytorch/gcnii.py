"""
Copied from https://github.com/chennnM/GCNII
"""
...
class GCNII(nn.Module):
    def __init__(self, nclass, nfeat, nlayers=16, nhidden=64, dropout=0.5, lamda=.5, alpha=0.1, variant=False, wd1=0.01, wd2=5e-4):
